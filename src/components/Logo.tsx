...
export function Logo({ size = 'md' }: { size?: 'sm' | 'md' | 'lg' }) {
  ...
  return (
    <div className="flex items-center gap-2.5">
      <img src="/seam-heart.webp" alt="SEAM" className={`${sizes.box} shrink-0 rounded-lg object-cover shadow-sm`} />
...
export function LogoHero({ className = 'h-40 w-40' }: { className?: string }) {
  return <img src="/seam-logo-full.webp" alt="SEAM — Cuidamos lo mejor de ti" className={`${className} mx-auto drop-shadow-sm`} />
}
